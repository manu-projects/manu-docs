...
#+EXPORT_FILE_NAME: ../../views/guia-git/git-2.html
...
*** Conceptos
    ...
    *Observaciones:*
    ...
    son cambios pendientes a agregar al *area de stage* piden a gritos agregar los cambios con git add
    ...
    4. Agregamos los archivos al "area de Stage" con ~git add~ los archivos serán rastreados, osea tendrán seguimiento de sus cambios
...
*** Referencias Oficiales
    1. [[https://git-scm.com/book/es/v2/Fundamentos-de-Git-Guardando-cambios-en-el-Repositorio][Guardando cambios en el Repositorio - git-scm.com]]
*** Referencias Extraoficiales
    1. [[https://howtogit.archive.pieterdedecker.be/concepts/types-of-changes.html][Types of Changes - pieterdedecker.be]]
** Stage
...
*** Referencias Web Oficiales
    1. [[https://mirrors.edge.kernel.org/pub/software/scm/git/docs/git-merge.html][Git Merge - Git Manual Page]]
** Detached Head
*** Conceptos
...
*** Referencias Web Extraoficiales
    1. [[https://loquemeinteresadelared.wordpress.com/2016/03/28/git-cookbook-que-es-el-estado-o-modo-detached-head/][Que es el estado detached head - Blog LoQueMeInteresaDeLaRed]]
** Master
...
*** Referencias Web Oficiales
  1. [[https://docs.github.com/es/github/collaborating-with-issues-and-pull-requests/about-branches][Colaborando con Issues y PRs - Branches - github.com]]
  2. [[https://docs.github.com/es/desktop/contributing-and-collaborating-using-github-desktop/managing-branches][Colaborando con github desktop - Branches - github.com]]
  3. [[https://git-scm.com/book/es/v2/Ramificaciones-en-Git-Procedimientos-B%C3%A1sicos-para-Ramificar-y-Fusionar][Ramificar y Fusionar - git-scm.com]]
  4. [[https://git-scm.com/book/es/v2/Ramificaciones-en-Git-Ramas-Remotas][Ramas remotas - git-scm.com]]
*** Referencias Web Extraoficiales
  1. [[https://www.atlassian.com/es/git/tutorials/using-branches/git-checkout][Git Checkout - Atlassian.com]]
** Commits
...
*** Ejemplos
    ...
    #+END_SRC
*** Referencias Extraoficiales
    1. [[https://marklodato.github.io/visual-git-guide/index-es.html][Referencia Visual de git - github.com, Marklodato]]
*** Referencias Issues
    1. [[https://stackoverflow.com/questions/3639342/whats-the-difference-between-git-reset-and-git-checkout][Difference between git reset and git checkout - stackoverflow.com]]
** Conflict Markers
* Interesante
** Git garbage collection process
  4. git garbage collection process
** Git patch mode
   1. [[https://paritosh-pundir.medium.com/take-control-of-your-commits-with-git-adds-patch-mode-2a5187590c3][Take control of your commits - Blog Paritosh]]
   2. [[https://css-tricks.com/git-add-patch-mode/][Add patch mode - css-tricks.com]]
   3. [[https://nuclearsquid.com/writings/git-add/][Add patch and interactive - nuclearsquid.com]]
** Tool rerere
  1. [[https://git-scm.com/book/en/v2/Git-Tools-Rerere][Book v2 Git tools - git-scm.com]]
  2. [[https://git-scm.com/docs/git-rerere][Docs - git-scm.com]]
** Otros
  1. [[https://git-scm.com/book/es/v2/Herramientas-de-Git-Revisión-por-selección][Herramientas - Revisión por selección - git-scm.com]]
  2. [[https://sparkbox.com/foundry/better_pull_requests_merge_requests_with_templates][PRs con Templates - sparkbox.com]]
  3. [[https://dzone.com/articles/a-tutorial-on-git-merge][Git Merge - Interpretación gráfica - dzone.com]]
  4. [[https://learngitbranching.js.org/][LearningGit - learninggitbranching.js.org]] (/muy interactivo/)
  5. [[https://www.vogella.com/tutorials/Git/article.html][Git Tutorial - vogella.com]]
* Workflows
** Git flow
*** Conceptos
*** Referencias Oficiales
    1. [[https://www.atlassian.com/git/tutorials/comparing-workflows][Comparando Workflows - Atlassian.com]]
*** Referencias Extraoficiales
    1. [[https://raygun.com/blog/git-workflow/][Git Workflow - Blog Raygun]]
** Github flow
*** Conceptos
*** Referencias Oficiales
    1. [[https://guides.github.com/introduction/flow/][Github Flow - github.com, Guides]]
    2. [[https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/github-flow][Colaborando con Issues+PRs - github.com, Docs]]
    3. [[https://githubflow.github.io/][Githubflow]]
*** Referencias Extraoficiales
    1. [[https://hackernoon.com/15-tips-to-enhance-your-github-flow-6af7ceb0d8a3][15 tips to enhance your github flow - hackernoon.com]]
** Trunk-based Development
*** Conceptos
*** Referencias Oficiales
    1. [[https://www.atlassian.com/continuous-delivery/continuous-integration/trunk-based-development][Continuous Delivery - Atlassian.com]]
    2. [[https://trunkbaseddevelopment.com/][Trunkbaseddevelopment]]
*** Referencias Extraoficiales
    1. [[https://dev.to/malvarezcr/por-que-trunk-based-development-i5n][Porque trunk base development - dev.to]]
** Referencias
*** Referencias Extraoficiales
    1. [[https://dev.to/arbitrarybytes/comparing-git-branching-strategies-dl4][Comparando estrategias para ramificar de git - dev.top]]
    2. [[https://www.toptal.com/software/trunk-based-development-git-flow][Trunk base development - toptal.com]]
* Problemas Comunes
...
*** Posible Solución
    ...
    #+END_SRC
*** Referencias Web Oficiales
    1. [[https://git-scm.com/book/es/v2/Fundamentos-de-Git-Guardando-cambios-en-el-Repositorio][Guardando cambios en el Repositorio - git-scm.com, Book v2]]
...
*** Posible Solución
    ...
    #+END_SRC
*** Referencias Web Extraoficiales
    1. [[https://howtogit.archive.pieterdedecker.be/recipes/prevent-change-from-being-committed.html][Deshacer cambios del área de preparación/stage - pieterdedecker.be]]
*** Referencias Issues
    2. [[https://stackoverflow.com/questions/3639342/whats-the-difference-between-git-reset-and-git-checkout][Diferencia entre git reset y git checkout - stackoverflow.com]]
...
*** Posibles Soluciones
    ...
    #+END_SRC
*** Referencias Web Oficiales
    1. [[https://git-scm.com/book/es/v2/Ramificaciones-en-Git-Ramas-Remotas][Ramas remotas - git-scm.com, Book v2]]
    2. [[https://git-scm.com/book/es/v2/Ramificaciones-en-Git-Procedimientos-B%C3%A1sicos-para-Ramificar-y-Fusionar#r_basic_merge_conflicts][Conflictos al mergear - git-scm.com, Book v2]]
    3. [[https://git-scm.com/docs/git-checkout][Git checkout - git-scm.com, Doc]]
    4. [[https://www.atlassian.com/es/git/tutorials/using-branches/git-checkout][Git checkout - atlassian.com]]
*** Referencias Issues
    1. [[https://stackoverflow.com/questions/2765421/how-do-i-push-a-new-local-branch-to-a-remote-git-repository-and-track-it-too][Como pushear una nueva rama local al repositorio remoto y rastrearlo - Stackoverfow.com]]
...
*** Eliminar branches remotos
   ...
   #+END_SRC
*** Referencias Web Extraoficiales
    1. [[https://www.educative.io/edpresso/how-to-delete-remote-branches-in-git][Como borrar ramas remotas - Educative.io]]
...
*** Formato diff3
    ...
    #+END_QUOTE
*** Referencias Web Oficiales
    1. [[https://git-scm.com/docs/merge-config][Conflictos al Mergear - git-scm.com, Docs]]
*** Referencias Web Extraoficiales
    1. [[https://dzone.com/articles/a-tutorial-on-git-merge][Git Merge - dzone.com]]
    2. [[https://blog.nilbus.com/take-the-pain-out-of-git-conflict-resolution-use-diff3/][Resolver conflictos con diff3 - Blog Nilbus]]
    3. [[https://blog.nilbus.com/temporary-merge-branch-in-diff3-conflict-markers/][Temporary Merge Branches - Blog Nilbus]]
    4. [[http://psung.blogspot.com/2011/02/reducing-merge-headaches-git-meets.html][Configurar git con diff3 - Blog Psung]]
*** Referencias Issues
    4. [[https://stackoverflow.com/questions/457927/git-workflow-and-rebase-vs-merge-questions/11219380#11219380][Rebase vs merge - Stackoverflow.com]]
** [TODO] Separar confirmaciones antes de una fusión
*** Conceptos
...
*** Posibles Soluciones
    ...
    #+END_SRC
*** Referencias Web Oficiales
    1. [[https://mirrors.edge.kernel.org/pub/software/scm/git/docs/git-stash.html][Comando git stash - Git, Docs]]
...
*** Posible Solución
    ...
    #+END_SRC
*** Referencias Web Extraoficiales
    1. [[https://midu.dev/como-deshacer-el-ultimo-commit-git/][Como deshacer el último commit - midu.dev]]
** Abortar Fusión
*** Posible Escenario
...
*** Posible solución
   ...
   #+END_SRC
*** Referencias Web Oficiales
    1. [[https://www.atlassian.com/es/git/tutorials/using-branches/merge-conflicts][Mergear conflictos - Atlassian.com]]
** Cambiar Archivos
*** Posible Escenario
...
*** Posibles Soluciones
    ...
    #+END_SRC
*** Referencias Web Extraoficiales
    1. [[https://nitaym.github.io/ourstheirs/][Ours vs Theirs - Github, Nitaym]]
    2. [[https://qastack.mx/programming/161813/how-to-resolve-merge-conflicts-in-git][Como resolver un conflicto por mergear - QAStack.mx]]
*** Referencias Issues
    1. [[https://stackoverflow.com/questions/25576415/what-is-the-precise-meaning-of-ours-and-theirs-in-git][Que significa Ours, Theirs en git? - Stackoverflow.com]]
...
**** Teclas atajo 
     ...
     |-------+-----------------------------------------------------------|
**** Referencias
     1. [[http://www.campisano.org/wiki/en/Emacs_(Application)][Configuración Emacs - Campisano.org, Wiki]]
...
**** Comandos y Teclas de atajo
     ...
     |-------+-------------------|
**** Referencias Youtube
     1. [[https://www.youtube.com/watch?v=wxh-AOxPX_A&ab_channel=AltitudeAirspeedAndIdeas][Referencia #1]]
**** Referencias Web Extraoficiales
     1. [[https://www.rosipov.com/blog/use-vimdiff-as-git-mergetool/#fromHistor][Vimdiff como herramienta para mergear - Blog, Rosipov.com]]
**** Referencias Issues
     1. [[https://qastack.mx/programming/161813/how-to-resolve-merge-conflicts-in-git][Como resolver conflictos - QAStack.mx]]
     2. [[https://qastack.mx/programming/4556184/vim-move-window-left-right][Vim, mover ventanas - QAStack.mx]]
     3. [[https://wiki.archlinux.org/index.php/vim][Vim - Wiki, ArchLinux.org]]
*** Referencias Web Oficiales
    1. [[https://mirrors.edge.kernel.org/pub/software/scm/git/docs/git-merge.html#_how_to_resolve_conflicts][Como resolver conflictos - Git Doc]]
    2. [[https://www.atlassian.com/es/git/tutorials/using-branches/merge-conflicts][Resolver conflictos por Merge - Atlassian.com]]
*** Referencias Web Extraoficiales
    1. [[https://psung.blogspot.com/2011/02/reducing-merge-headaches-git-meets.html][Resolver conflictos con diff3 - Blog, Psung (repetido)]]
    2. [[https://nitaym.github.io/ourstheirs/][Ours Vs Theirs - Github, Nitaym (repetido)]]
** Referencias
*** Referencias Web Oficiales
    1. [[https://docs.github.com/es/enterprise-server@2.21/github/collaborating-with-issues-and-pull-requests/resolving-a-merge-conflict-using-the-command-line][Colaborando con issues+PRs - Docs, Github.com]]
    2. [[http://git-scm.com/docs/git-merge#_how_conflicts_are_presented][Introducción sobre Conflictos en Git - Docs, git-scm.com]]
    3. [[http://www.git-scm.com/docs/git-merge][Comando merge - Docs, git-scm.com]]
...
** Merge Vs Rebase
*** Referencias Issues
    1. [[https://stackoverflow.com/questions/457927/git-workflow-and-rebase-vs-merge-questions/11219380#11219380][Rebase Vs Merge - Stackoverflow.com (repetido)]]
*** Referencias Web Extraoficiales
    1. [[https://randyfay.com/content/rebase-workflow-git][Merge workflow - Blog, RandyFay.com]]
    2. [[http://www.randyfay.com/node/89][Evitar desastres con git - Blog, RandyFay.com]]
** Referencias Web Oficiales
   1. [[https://git-scm.com/book/es/v2/Herramientas-de-Git-Fusi%C3%B3n-Avanzada][Herramientas para Fusión (Avanzado) - Book v2, git-scm.com]]
   2. [[https://git-scm.com/book/es/v2/Ramificaciones-en-Git-Reorganizar-el-Trabajo-Realizado#r_rebase_peril][El peligro de reorganizar (rebase) confirmaciones de cambio - Book v2, git-scm.com]]
   3. [[https://git-scm.com/book/es/v2/Herramientas-de-Git-Reiniciar-Desmitificado#r_git_reset][Git Reset como funciona - Book v2, git-scm.com]]
   4. [[https://git-scm.com/book/en/v2/Git-Tools-Advanced-Merging][Herramientas para Mergear (Avanzado) - Book v2, git-scm.com]]
** Referencias Web Extraoficiales
   1. [[https://gitolite.com/git-pull--rebase][Comando git pull --rebase - gitolite.com]] 
* [TODO] Otros
  #+BEGIN_COMMENT
  *OFICIALES*
  ...
  8. https://git-scm.com/book/es/v2/Fundamentos-de-Git-Etiquetado (cuando crear tags para release)
