...
*** Deshacer cambios locales
    ...
    *Observación:*
    Un cambio es local, cuando modificas archivos con tu editor de texto, y guardas los cambios.
...
*** Deshacer cambios con "reset" sin borrar historial (stage)
    ...
    *Observación:*
    El hash de un commit se puede obtener utilizando **git log --oneline** aparece a la iquierda de mensaje
...
* Referencias Web
 ...
 - Interpretacion grafica del comando **commit** [Ver Pagina](https://pvigier.github.io/2019/05/06/commit-graph-drawing-algorithms.html)
 - Diferencias entre los comandos **rebase** y **merge** [Ver Pagina](https://medium.com/datadriveninvestor/git-rebase-vs-merge-cc5199edd77c)
 - Interpretacion grafica del historial [Ver Pagina](https://www.bitsnbites.eu/a-tidy-linear-git-history/)
 - Tutorial de Git [Ver Pagina](https://www.slideshare.net/th507/git-an-intro-of-plumbing-and-porcelain-commands)
 - Interpretacion grafica del historial y comandos [Ver Pagina](https://jeffsaracco.com/Happy-git-Trees/)
* Referencias Youtube
  - Comandos **fetch** **pull** y **rebase** [Ver Video](https://www.youtube.com/watch?v=r-PTFYVmGNo)
