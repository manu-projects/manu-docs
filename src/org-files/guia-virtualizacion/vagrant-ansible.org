...
*** [TODO] Agregamos el pacstrap
    ...
    #+END_SRC
*** [TODO] Otros paquetes necesarios
    #+NAME: 
    #+BEGIN_SRC shell
...
*** Modificamos la configuracion en hosts
    Modificamos el archivo *hosts* mediante *vim /etc/hosts*
    y nos fijamos que quede de la siguiente manera
    ...
    #+END_SRC
*** Modificamos los DNS
    Modificamos el archivo *resolv.conf* mediante *vim /etc/resolv.conf*
    y nos fijamos que quede de la siguiente manera
...
*** Agregamos la nueva unidad al filesystem
    Modificamos el archivo *fstab* mediante *vim /etc/fstab*
    y revisamos que nos quede similar a lo siguiente
