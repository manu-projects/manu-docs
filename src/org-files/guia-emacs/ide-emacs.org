...
* Referencias
 - Configuración del archivo Init, ErgoEmacs [[http://ergoemacs.org/emacs/emacs_make_modern.html][Ver Página]]
 - Utilizando el Editor de Directorios, GNU [[http://dinasis.com/oliver/Learning_GNU_Emacs/gnu3-CHP-5-SECT-2.html][Ver Página]]
 - Documentación Oficial, GNU.org [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Exiting.html][Ver Página]]
 - Referencia de comandos, EmacsWiki [[https://www.emacswiki.org/emacs/EmacsNewbieKeyReference][Ver Página]]
 - Comando C-M-v Scroll-other-window, GNU.org [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Other-Window.html][Ver Página]]
 - Renombrar multiples archivos [[http://pragmaticemacs.com/emacs/dired-rename-multiple-files/][Ver Página]]
