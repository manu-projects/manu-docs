...
** Automatización de Tareas
   - [NUEVO] Makefile + Automatizar pequeños proyectos de C ó java [[file:guia-makefile/makefile-basico.org][[Ir a la pagina]​]]
   - [PENDIENTE] Makefile + Automatizar entornos de trabajo e integración con Docker
   - [PENDIENTE] Makefile Vs Taskfile
   - [PENDIENTE] Gestores de tareas en Javascript
